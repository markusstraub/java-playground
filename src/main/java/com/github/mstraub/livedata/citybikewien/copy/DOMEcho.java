...
// JAXP packages
package com.github.mstraub.livedata.citybikewien.copy;
 ...
 * 
 * Note: Program flags may be used to create non-conformant but possibly useful
 * DOM trees. In some cases, particularly with element content whitespace,
 * applications may not want to rely on JAXP to filter out these nodes but may
 * want to skip the nodes themselves so the application will be more robust.
 * 
